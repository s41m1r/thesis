...
\todo[inline]{Overview. Probably okay as is.}
...
We propose a process to extract and represent the work processes and their dependencies. This process consists of 4 steps, has as input a VCS log and as output a visualization of the knowledge extracted. It is depicted in \Cref{fig:visualization-process}. 
