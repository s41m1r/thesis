...
This thesis combines ideas from the above mentioned areas to devise algorithms for mining the software development process. \Cref{table:literature-classification} lists summarizes the most relevant types of contribution in the literature and classifies them in relation the addressed research questions. In particular, the Artifacts \textbf{A1} – \textbf{A4} produced in this dissertation aim at bridging the two disciplines for to give the manager improved insights on the software process.
%	
