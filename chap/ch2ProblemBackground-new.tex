...
Visualisation approaches aim at taming the complexity of information contained in repositories by providing visual aids to navigate through them. Such navigation is rendered using various representations. Notable representations here are software as cities \cite{Lanza} , graph-based visualisations \cite{bibid} and various charts \cite{dambros,etc}. In this class fall also various attempts to apply process mining \cite{process mining can be applied to software too, marquez, jooken}. 
