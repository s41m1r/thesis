...
\todoinline{Organize this!}
\todo[inline]{What is it}
...
\todoinline{What is there to show "process" information: mining relations, visualisation, explicit "process mining"}
...
Visualisation approaches aim at taming the high amount of information contained in repositories by providing visual aids to navigate through it. Such navigation is rendered using various representations \citep{DBLP:journals/scp/TorresGSP16}. Notable representations here are software as cities \cite{DBLP:conf/vissoft/WettelL07} , graph-based visualisations \cite{DAmbros2009} and various charts \cite{dambros,etc}. In this class fall also various attempts to apply process mining \cite{process mining can be applied to software too, marquez, jooken}. 
...
\todoinline{This thesis focuses on ...}
