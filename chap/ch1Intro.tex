...
\todoinline{Jan's comment: "Mind your reviewers https://aisel.aisnet.org/jais/vol21/iss6/2/"}
\todoinline{Saimir's comment: In the linked paper, the authors propose a new way of describing design principles. Q: should I make an instance of their schema for each of my articles? Or would it be sufficient to include them in the discourse (e.g., one or two sentences recognizing their contribution)}
