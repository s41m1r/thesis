...
\todo[inline]{Double check cross-references.}
...
\todo[inline]{Missing publications: Eli (BPM Cases) Maxim, PoEM 2018 (Phactum paper), EdBA 2020 Paper with Philipp, PoEM 2020 Forum. Missing ongoing publications: Kathi, Damjan, Waldemar}
...
\end{itemize}
Further work published in the \gls{bpm} area is the following.
...
\begin{itemize}
	...
	\item Bala, S., Mendling, J., Schimak, M. and Queteschiner, P., 2018, October. Case and activity identification for mining process models from middleware. In IFIP Working Conference on The Practice of Enterprise Modeling (pp. 86-102). Springer, Cham. \citep{DBLP:conf/ifip8-1/BalaMSQ18}
	...
	\item Vidgof, M., Djurica, D., \textbf{Bala, S.}, and Mendling, J. (2020). Cherry-picking from
