...
\begin{itemize}
	...
	\todoinline{on page 126, you have a short paragraph on user evaluation. This is too should. Best you write ~1 page how further user studies can be done based on references on design science (e.g. Roel Wieringa) and InfoVis (see attached)}
